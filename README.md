...
## Before You Submit (assignment checklist)

- [ ] Runs from these instructions, accepts new PDFs via the UI/API.
- [ ] Results show facts, source evidence (quote + page), and cross-document relationships.
- [ ] Demonstrated all four required cases (corroboration, contradiction, contextual reconciliation, a real failure) — capture these in the demo video.
- [ ] Approach + limitations documented above.
- [ ] Demo video ≤3 minutes, linked above.
